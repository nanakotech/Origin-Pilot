...
htmlhelp_basename = 'pyqpanda-algorithm-introduction'
...
man_pages = [
    (root_doc, 'pyqpanda-algorithm-introduction', 'pyqpanda-algorithm Introduction',
     [author], 1)
]
...
texinfo_documents = [
    (root_doc, 'pyqpanda-algorithm-introduction', 'pyqpanda-algorithm introduction',
     author, 'pyqpanda-algorithm-introduction', 'One line description of project.',
     'Miscellaneous'),
]
